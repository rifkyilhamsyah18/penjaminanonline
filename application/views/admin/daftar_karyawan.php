        ...
        <div class="row">
          <div class="col-12">
            <div class="row">
                ...
                <div class="col-md-2">
                    <button class="btn btn-primary btn-sm" id="add-karyawan" data-target="#add-karyawan-modal" data-toggle="modal">Tambah Karyawan</button>
                </div>
                ...
                <table id="daftar_karyawan" class="table table-bordered table-hover table-sm">
                  <thead>
                    <tr>
                      ...
                      <th class="align-middle" style="width: 55px;">Status</th>
